...
},r.prototype.dragMove=function(t,e,i){o(t),this.emitEvent("dragMove",[t,e,i])},r.prototype._dragEnd=function(t,e){this.isDragging=!1;var i=this;setTimeout(function(){delete i.isPreventingClicks}),this.dragEnd(t,e)},r.prototype.dragEnd=function(t,e){this.emitEvent("dragEnd",[t,e])},r.prototype.pointerDone=function(){e.unbind(t,"scroll",this),delete this.pointerDownScroll},r.prototype.onclick=function(t){this.isPreventingClicks&&o(t)},r.prototype._staticClick=function(t,e){if(!this.isIgnoringMouseUp||"mouseup"!=t.type){var i=t.target.nodeName;if(("INPUT"==i||"TEXTAREA"==i)&&t.target.focus(),this.staticClick(t,e),"mouseup"!=t.type){this.isIgnoringMouseUp=!0;var n=this;setTimeout(function(){delete n.isIgnoringMouseUp},400)}}},r.prototype.staticClick=function(t,e){this.emitEvent("staticClick",[t,e])},r.prototype.onscroll=function(){var t=r.getScrollPosition(),e=this.pointerDownScroll.x-t.x,i=this.pointerDownScroll.y-t.y;(Math.abs(e)>3||Math.abs(i)>3)&&this._pointerDone()},r.getPointerPoint=function(t){return{x:void 0!==t.pageX?t.pageX:t.clientX,y:void 0!==t.pageY?t.pageY:t.clientY}};var h=void 0!==t.pageYOffset;return r.getScrollPosition=function(){return{x:h?t.pageXOffset:document.body.scrollLeft,y:h?t.pageYOffset:document.body.scrollTop}},r.getPointerPoint=i.getPointerPoint,r}),function(t,e){"function"==typeof define&&define.amd?define("flickity/js/drag",["classie/classie","eventie/eventie","./flickity","unidragger/unidragger","fizzy-ui-utils/utils"],function(i,n,o,r,s){return e(t,i,n,o,r,s)}):"object"==typeof exports?module.exports=e(t,require("desandro-classie"),require("eventie"),require("./flickity"),require("unidragger"),require("fizzy-ui-utils")):t.Flickity=e(t,t.classie,t.eventie,t.Flickity,t.Unidragger,t.fizzyUIUtils)}(window,function(t,e,i,n,o,r){function s(t){t.preventDefault?t.preventDefault():t.returnValue=!1}function a(e){var i=o.getPointerPoint(e);return i.y-t.pageYOffset}r.extend(n.defaults,{draggable:!0,touchVerticalScroll:!0}),n.createMethods.push("_createDrag"),r.extend(n.prototype,o.prototype),n.prototype._createDrag=function(){this.on("activate",this.bindDrag),this.on("uiChange",this._uiChangeDrag),this.on("childUIPointerDown",this._childUIPointerDownDrag),this.on("deactivate",this.unbindDrag)},n.prototype.bindDrag=function(){this.options.draggable&&!this.isDragBound&&(e.add(this.element,"is-draggable"),this.handles=[this.viewport],this.bindHandles(),this.isDragBound=!0)},n.prototype.unbindDrag=function(){this.isDragBound&&(e.remove(this.element,"is-draggable"),this.unbindHandles(),delete this.isDragBound)},n.prototype._uiChangeDrag=function(){delete this.isFreeScrolling},n.prototype._childUIPointerDownDrag=function(t){s(t),this.pointerDownFocus(t)},n.prototype.pointerDown=function(n,r){if("INPUT"==n.target.nodeName&&"range"==n.target.type)return this.isPointerDown=!1,void delete this.pointerIdentifier;this._dragPointerDown(n,r);var s=document.activeElement;s&&s.blur&&s!=this.element&&s!=document.body&&s.blur(),this.pointerDownFocus(n),this.dragX=this.x,e.add(this.viewport,"is-pointer-down"),this._bindPostStartEvents(n),this.pointerDownScroll=o.getScrollPosition(),i.bind(t,"scroll",this),this.dispatchEvent("pointerDown",n,[r])};var l={touchstart:!0,MSPointerDown:!0},c={INPUT:!0,SELECT:!0};n.prototype.pointerDownFocus=function(t){!this.options.accessibility||l[t.type]||c[t.target.nodeName]||this.element.focus()},n.prototype.pointerMove=function(t,e){var i=this._dragPointerMove(t,e);this.touchVerticalScrollMove(t,e,i),this._dragMove(t,e,i),this.dispatchEvent("pointerMove",t,[e,i])},n.prototype.hasDragStarted=function(t){return!this.isTouchScrolling&&Math.abs(t.x)>3},n.prototype.pointerUp=function(t,i){delete this.isTouchScrolling,e.remove(this.viewport,"is-pointer-down"),this.dispatchEvent("pointerUp",t,[i]),this._dragPointerUp(t,i)};var h={touchmove:!0,MSPointerMove:!0};return n.prototype.touchVerticalScrollMove=function(e,i,n){var o=this.options.touchVerticalScroll,r="withDrag"==o?!o:this.isDragging||!o;!r&&h[e.type]&&!this.isTouchScrolling&&Math.abs(n.y)>10&&(this.startScrollY=t.pageYOffset,this.pointerWindowStartY=a(i),this.isTouchScrolling=!0)},n.prototype.dragStart=function(t,e){this.dragStartPosition=this.x,this.startAnimation(),this.dispatchEvent("dragStart",t,[e])},n.prototype.dragMove=function(t,e,i){s(t),this.previousDragX=this.dragX;var n=this.options.rightToLeft?-1:1,o=this.dragStartPosition+i.x*n;if(!this.options.wrapAround&&this.cells.length){var r=Math.max(-this.cells[0].target,this.dragStartPosition);o=o>r?.5*(o+r):o;var a=Math.min(-this.getLastCell().target,this.dragStartPosition);o=a>o?.5*(o+a):o}this.dragX=o,this.dragMoveTime=new Date,this.dispatchEvent("dragMove",t,[e,i])},n.prototype.dragEnd=function(t,e){this.options.freeScroll&&(this.isFreeScrolling=!0);var i=this.dragEndRestingSelect();if(this.options.freeScroll&&!this.options.wrapAround){var n=this.getRestingPosition();this.isFreeScrolling=-n>this.cells[0].target&&-n<this.getLastCell().target}else this.options.freeScroll||i!=this.selectedIndex||(i+=this.dragEndBoostSelect());delete this.previousDragX,this.select(i),this.dispatchEvent("dragEnd",t,[e])},n.prototype.dragEndRestingSelect=function(){var t=this.getRestingPosition(),e=Math.abs(this.getCellDistance(-t,this.selectedIndex)),i=this._getClosestResting(t,e,1),n=this._getClosestResting(t,e,-1),o=i.distance<n.distance?i.index:n.index;return o},n.prototype._getClosestResting=function(t,e,i){for(var n=this.selectedIndex,o=1/0,r=this.options.contain&&!this.options.wrapAround?function(t,e){return e>=t}:function(t,e){return e>t};r(e,o)&&(n+=i,o=e,e=this.getCellDistance(-t,n),null!==e);)e=Math.abs(e);return{distance:o,index:n-i}},n.prototype.getCellDistance=function(t,e){var i=this.cells.length,n=this.options.wrapAround&&i>1,o=n?r.modulo(e,i):e,s=this.cells[o];if(!s)return null;var a=n?this.slideableWidth*Math.floor(e/i):0;return t-(s.target+a)},n.prototype.dragEndBoostSelect=function(){if(void 0===this.previousDragX||!this.dragMoveTime||new Date-this.dragMoveTime>100)return 0;var t=this.getCellDistance(-this.dragX,this.selectedIndex),e=this.previousDragX-this.dragX;return t>0&&e>0?1:0>t&&0>e?-1:0},n.prototype.staticClick=function(t,e){var i=this.getParentCell(t.target),n=i&&i.element,o=i&&r.indexOf(this.cells,i);this.dispatchEvent("staticClick",t,[e,n,o])},n}),function(t,e){"function"==typeof define&&define.amd?define("tap-listener/tap-listener",["unipointer/unipointer"],function(i){return e(t,i)}):"object"==typeof exports?module.exports=e(t,require("unipointer")):t.TapListener=e(t,t.Unipointer)}(window,function(t,e){function i(t){t.preventDefault?t.preventDefault():t.returnValue=!1}function n(t){this.bindTap(t)}n.prototype=new e,n.prototype.bindTap=function(t){t&&(this.unbindTap(),this.tapElement=t,this._bindStartEvent(t,!0))},n.prototype.unbindTap=function(){this.tapElement&&(this._bindStartEvent(this.tapElement,!0),delete this.tapElement)};var o=n.prototype.pointerDown;n.prototype.pointerDown=function(t){"touchstart"==t.type&&i(t),o.apply(this,arguments)};var r=void 0!==t.pageYOffset;return n.prototype.pointerUp=function(i,n){var o=e.getPointerPoint(n),s=this.tapElement.getBoundingClientRect(),a=r?t.pageXOffset:document.body.scrollLeft,l=r?t.pageYOffset:document.body.scrollTop,c=o.x>=s.left+a&&o.x<=s.right+a&&o.y>=s.top+l&&o.y<=s.bottom+l;c&&this.emitEvent("tap",[i,n])},n.prototype.destroy=function(){this.pointerDone(),this.unbindTap()},n}),function(t,e){"function"==typeof define&&define.amd?define("flickity/js/prev-next-button",["eventie/eventie","./flickity","tap-listener/tap-listener","fizzy-ui-utils/utils"],function(i,n,o,r){return e(t,i,n,o,r)}):"object"==typeof exports?module.exports=e(t,require("eventie"),require("./flickity"),require("tap-listener"),require("fizzy-ui-utils")):e(t,t.eventie,t.Flickity,t.TapListener,t.fizzyUIUtils)}(window,function(t,e,i,n,o){function r(t,e){this.direction=t,this.parent=e,this._create()}function s(t){return"string"==typeof t?t:"M "+t.x0+",50 L "+t.x1+","+(t.y1+50)+" L "+t.x2+","+(t.y2+50)+" L "+t.x3+",50  L "+t.x2+","+(50-t.y2)+" L "+t.x1+","+(50-t.y1)+" Z"}var a="http://www.w3.org/2000/svg",l=function(){function t(){if(void 0!==e)return e;var t=document.createElement("div");return t.innerHTML="<svg/>",e=(t.firstChild&&t.firstChild.namespaceURI)==a}var e;return t}();return r.prototype=new n,r.prototype._create=function(){this.isEnabled=!0,this.isPrevious=-1==this.direction;var t=this.parent.options.rightToLeft?1:-1;this.isLeft=this.direction==t;var e=this.element=document.createElement("button");if(e.className="flickity-prev-next-button",e.className+=this.isPrevious?" previous":" next",e.setAttribute("type","button"),i.setUnselectable(e),l()){var n=this.createSVG();e.appendChild(n)}else this.setArrowText(),e.className+=" no-svg";var o=this;this.onCellSelect=function(){o.update()},this.parent.on("cellSelect",this.onCellSelect),this.on("tap",this.onTap),this.on("pointerDown",function(t,e){o.parent.childUIPointerDown(e)})},r.prototype.activate=function(){this.update(),this.bindTap(this.element),e.bind(this.element,"click",this),this.parent.element.appendChild(this.element)},r.prototype.deactivate=function(){this.parent.element.removeChild(this.element),n.prototype.destroy.call(this),e.unbind(this.element,"click",this)},r.prototype.createSVG=function(){var t=document.createElementNS(a,"svg");t.setAttribute("viewBox","0 0 100 100");var e=document.createElementNS(a,"path"),i=s(this.parent.options.arrowShape);return e.setAttribute("d",i),e.setAttribute("class","arrow"),this.isLeft||e.setAttribute("transform","translate(100, 100) rotate(180) "),t.appendChild(e),t},r.prototype.setArrowText=function(){var t=this.parent.options,e=this.isLeft?t.leftArrowText:t.rightArrowText;o.setText(this.element,e)},r.prototype.onTap=function(){if(this.isEnabled){this.parent.uiChange();var t=this.isPrevious?"previous":"next";this.parent[t]()}},r.prototype.handleEvent=o.handleEvent,r.prototype.onclick=function(){var t=document.activeElement;t&&t==this.element&&this.onTap()},r.prototype.enable=function(){this.isEnabled||(this.element.disabled=!1,this.isEnabled=!0)},r.prototype.disable=function(){this.isEnabled&&(this.element.disabled=!0,this.isEnabled=!1)},r.prototype.update=function(){var t=this.parent.cells;if(this.parent.options.wrapAround&&t.length>1)return void this.enable();var e=t.length?t.length-1:0,i=this.isPrevious?0:e,n=this.parent.selectedIndex==i?"disable":"enable";this[n]()},r.prototype.destroy=function(){this.deactivate()},o.extend(i.defaults,{prevNextButtons:!0,leftArrowText:"‹",rightArrowText:"›",arrowShape:{x0:10,x1:60,y1:50,x2:70,y2:40,x3:30}}),i.createMethods.push("_createPrevNextButtons"),i.prototype._createPrevNextButtons=function(){this.options.prevNextButtons&&(this.prevButton=new r(-1,this),this.nextButton=new r(1,this),this.on("activate",this.activatePrevNextButtons))},i.prototype.activatePrevNextButtons=function(){this.prevButton.activate(),this.nextButton.activate(),this.on("deactivate",this.deactivatePrevNextButtons)},i.prototype.deactivatePrevNextButtons=function(){this.prevButton.deactivate(),this.nextButton.deactivate(),this.off("deactivate",this.deactivatePrevNextButtons)},i.PrevNextButton=r,i}),function(t,e){"function"==typeof define&&define.amd?define("flickity/js/page-dots",["eventie/eventie","./flickity","tap-listener/tap-listener","fizzy-ui-utils/utils"],function(i,n,o,r){return e(t,i,n,o,r)}):"object"==typeof exports?module.exports=e(t,require("eventie"),require("./flickity"),require("tap-listener"),require("fizzy-ui-utils")):e(t,t.eventie,t.Flickity,t.TapListener,t.fizzyUIUtils)}(window,function(t,e,i,n,o){function r(t){this.parent=t,this._create()}return r.prototype=new n,r.prototype._create=function(){this.holder=document.createElement("ol"),this.holder.className="flickity-page-dots",i.setUnselectable(this.holder),this.dots=[];var t=this;this.onCellSelect=function(){t.updateSelected()},this.parent.on("cellSelect",this.onCellSelect),this.on("tap",this.onTap),this.on("pointerDown",function(e,i){t.parent.childUIPointerDown(i)})},r.prototype.activate=function(){this.setDots(),this.updateSelected(),this.bindTap(this.holder),this.parent.element.appendChild(this.holder)},r.prototype.deactivate=function(){this.parent.element.removeChild(this.holder),n.prototype.destroy.call(this)},r.prototype.setDots=function(){var t=this.parent.cells.length-this.dots.length;t>0?this.addDots(t):0>t&&this.removeDots(-t)},r.prototype.addDots=function(t){for(var e=document.createDocumentFragment(),i=[];t;){var n=document.createElement("li");n.className="dot",e.appendChild(n),i.push(n),t--}this.holder.appendChild(e),this.dots=this.dots.concat(i)},r.prototype.removeDots=function(t){for(var e=this.dots.splice(this.dots.length-t,t),i=0,n=e.length;n>i;i++){var o=e[i];this.holder.removeChild(o)}},r.prototype.updateSelected=function(){this.selectedDot&&(this.selectedDot.className="dot"),this.dots.length&&(this.selectedDot=this.dots[this.parent.selectedIndex],this.selectedDot.className="dot is-selected")},r.prototype.onTap=function(t){var e=t.target;if("LI"==e.nodeName){this.parent.uiChange();var i=o.indexOf(this.dots,e);this.parent.select(i)}},r.prototype.destroy=function(){this.deactivate()},i.PageDots=r,o.extend(i.defaults,{pageDots:!0}),i.createMethods.push("_createPageDots"),i.prototype._createPageDots=function(){this.options.pageDots&&(this.pageDots=new r(this),this.on("activate",this.activatePageDots),this.on("cellAddedRemoved",this.onCellAddedRemovedPageDots),this.on("deactivate",this.deactivatePageDots))},i.prototype.activatePageDots=function(){this.pageDots.activate()},i.prototype.onCellAddedRemovedPageDots=function(){this.pageDots.setDots()},i.prototype.deactivatePageDots=function(){this.pageDots.deactivate()},i.PageDots=r,i}),function(t,e){"function"==typeof define&&define.amd?define("flickity/js/player",["eventEmitter/EventEmitter","eventie/eventie","./flickity"],function(t,i,n){return e(t,i,n)}):"object"==typeof exports?module.exports=e(require("wolfy87-eventemitter"),require("eventie"),require("./flickity")):e(t.EventEmitter,t.eventie,t.Flickity)}(window,function(t,e,i){function n(t){if(this.isPlaying=!1,this.parent=t,r){var e=this;this.onVisibilityChange=function(){e.visibilityChange()}}}var o,r;return"hidden"in document?(o="hidden",r="visibilitychange"):"webkitHidden"in document&&(o="webkitHidden",r="webkitvisibilitychange"),n.prototype=new t,n.prototype.play=function(){this.isPlaying=!0,delete this.isPaused,r&&document.addEventListener(r,this.onVisibilityChange,!1),this.tick()},n.prototype.tick=function(){if(this.isPlaying&&!this.isPaused){this.tickTime=new Date;var t=this.parent.options.autoPlay;t="number"==typeof t?t:3e3;var e=this;this.timeout=setTimeout(function(){e.parent.next(!0),e.tick()},t)}},n.prototype.stop=function(){this.isPlaying=!1,delete this.isPaused,this.clear(),r&&document.removeEventListener(r,this.onVisibilityChange,!1)},n.prototype.clear=function(){clearTimeout(this.timeout)},n.prototype.pause=function(){this.isPlaying&&(this.isPaused=!0,this.clear())},n.prototype.unpause=function(){this.isPaused&&this.play()},n.prototype.visibilityChange=function(){var t=document[o];this[t?"pause":"unpause"]()},i.createMethods.push("_createPlayer"),i.prototype._createPlayer=function(){this.player=new n(this),this.on("activate",this.activatePlayer),this.on("uiChange",this.stopPlayer),this.on("pointerDown",this.stopPlayer),this.on("deactivate",this.deactivatePlayer)},i.prototype.activatePlayer=function(){this.options.autoPlay&&(this.player.play(),e.bind(this.element,"mouseenter",this),this.isMouseenterBound=!0)},i.prototype.stopPlayer=function(){this.player.stop()},i.prototype.deactivatePlayer=function(){this.player.stop(),this.isMouseenterBound&&(e.unbind(this.element,"mouseenter",this),delete this.isMouseenterBound)},i.prototype.onmouseenter=function(){this.player.pause(),e.bind(this.element,"mouseleave",this)},i.prototype.onmouseleave=function(){this.player.unpause(),e.unbind(this.element,"mouseleave",this)},i.Player=n,i}),function(t,e){"function"==typeof define&&define.amd?define("flickity/js/add-remove-cell",["./flickity","fizzy-ui-utils/utils"],function(i,n){return e(t,i,n)}):"object"==typeof exports?module.exports=e(t,require("./flickity"),require("fizzy-ui-utils")):e(t,t.Flickity,t.fizzyUIUtils)}(window,function(t,e,i){function n(t){for(var e=document.createDocumentFragment(),i=0,n=t.length;n>i;i++){var o=t[i];e.appendChild(o.element)}return e}return e.prototype.insert=function(t,e){var i=this._makeCells(t);if(i&&i.length){var o=this.cells.length;e=void 0===e?o:e;var r=n(i),s=e==o;if(s)this.slider.appendChild(r);else{var a=this.cells[e].element;this.slider.insertBefore(r,a)}if(0===e)this.cells=i.concat(this.cells);else if(s)this.cells=this.cells.concat(i);else{var l=this.cells.splice(e,o-e);this.cells=this.cells.concat(i).concat(l)}this._sizeCells(i);var c=e>this.selectedIndex?0:i.length;this._cellAddedRemoved(e,c)}},e.prototype.append=function(t){this.insert(t,this.cells.length)},e.prototype.prepend=function(t){this.insert(t,0)},e.prototype.remove=function(t){var e,n,o,r=this.getCells(t),s=0;for(e=0,n=r.length;n>e;e++){o=r[e];var a=i.indexOf(this.cells,o)<this.selectedIndex;s-=a?1:0}for(e=0,n=r.length;n>e;e++)o=r[e],o.remove(),i.removeFrom(this.cells,o);r.length&&this._cellAddedRemoved(0,s)},e.prototype._cellAddedRemoved=function(t,e){e=e||0,this.selectedIndex+=e,this.selectedIndex=Math.max(0,Math.min(this.cells.length-1,this.selectedIndex)),this.emitEvent("cellAddedRemoved",[t,e]),this.cellChange(t,!0)},e.prototype.cellSizeChange=function(t){var e=this.getCell(t);if(e){e.getSize();var n=i.indexOf(this.cells,e);this.cellChange(n)}},e.prototype.cellChange=function(t,e){var i=this.slideableWidth;this._positionCells(t),this._getWrapShiftCells(),this.setGallerySize(),this.options.freeScroll?(this.x+=i-this.slideableWidth,this.positionSlider()):(e&&this.positionSliderAtSelected(),this.select(this.selectedIndex))},e}),function(t,e){"function"==typeof define&&define.amd?define("flickity/js/lazyload",["classie/classie","eventie/eventie","./flickity","fizzy-ui-utils/utils"],function(i,n,o,r){return e(t,i,n,o,r)}):"object"==typeof exports?module.exports=e(t,require("desandro-classie"),require("eventie"),require("./flickity"),require("fizzy-ui-utils")):e(t,t.classie,t.eventie,t.Flickity,t.fizzyUIUtils)}(window,function(t,e,i,n,o){function r(t){if("IMG"==t.nodeName&&t.getAttribute("data-flickity-lazyload"))return[t];var e=t.querySelectorAll("img[data-flickity-lazyload]");return o.makeArray(e)}function s(t,e){this.img=t,this.flickity=e,this.load()}return n.createMethods.push("_createLazyload"),n.prototype._createLazyload=function(){this.on("cellSelect",this.lazyLoad)},n.prototype.lazyLoad=function(){var t=this.options.lazyLoad;if(t){for(var e="number"==typeof t?t:0,i=this.getAdjacentCellElements(e),n=[],o=0,a=i.length;a>o;o++){var l=i[o],c=r(l);n=n.concat(c)}for(o=0,a=n.length;a>o;o++){var h=n[o];new s(h,this)}}},s.prototype.handleEvent=o.handleEvent,s.prototype.load=function(){i.bind(this.img,"load",this),i.bind(this.img,"error",this),this.img.src=this.img.getAttribute("data-flickity-lazyload"),this.img.removeAttribute("data-flickity-lazyload")},s.prototype.onload=function(t){this.complete(t,"flickity-lazyloaded")},s.prototype.onerror=function(){this.complete(event,"flickity-lazyerror")},s.prototype.complete=function(t,n){i.unbind(this.img,"load",this),i.unbind(this.img,"error",this);var o=this.flickity.getParentCell(this.img),r=o&&o.element;this.flickity.cellSizeChange(r),e.add(this.img,n),this.flickity.dispatchEvent("lazyLoad",t,r)},n.LazyLoader=s,n}),function(t,e){"function"==typeof define&&define.amd?define("flickity/js/index",["./flickity","./drag","./prev-next-button","./page-dots","./player","./add-remove-cell","./lazyload"],e):"object"==typeof exports&&(module.exports=e(require("./flickity"),require("./drag"),require("./prev-next-button"),require("./page-dots"),require("./player"),require("./add-remove-cell"),require("./lazyload")))}(window,function(t){return t}),function(t,e){"function"==typeof define&&define.amd?define("flickity-as-nav-for/as-nav-for",["classie/classie","flickity/js/index","fizzy-ui-utils/utils"],function(i,n,o){return e(t,i,n,o)}):"object"==typeof exports?module.exports=e(t,require("desandro-classie"),require("flickity"),require("fizzy-ui-utils")):t.Flickity=e(t,t.classie,t.Flickity,t.fizzyUIUtils)}(window,function(t,e,i,n){return i.createMethods.push("_createAsNavFor"),i.prototype._createAsNavFor=function(){this.on("activate",this.activateAsNavFor),this.on("deactivate",this.deactivateAsNavFor),this.on("destroy",this.destroyAsNavFor);var t=this.options.asNavFor;if(t){var e=this;setTimeout(function(){e.setNavCompanion(t)})}},i.prototype.setNavCompanion=function(t){t=n.getQueryElement(t);var e=i.data(t);if(e&&e!=this){this.navCompanion=e;var o=this;this.onNavCompanionSelect=function(){o.navCompanionSelect()},e.on("cellSelect",this.onNavCompanionSelect),this.on("staticClick",this.onNavStaticClick),this.navCompanionSelect()}},i.prototype.navCompanionSelect=function(){if(this.navCompanion){var t=this.navCompanion.selectedIndex;this.select(t),this.removeNavSelectedElement(),this.selectedIndex==t&&(this.navSelectedElement=this.cells[t].element,e.add(this.navSelectedElement,"is-nav-selected"))}},i.prototype.activateAsNavFor=function(){this.navCompanionSelect()},i.prototype.removeNavSelectedElement=function(){this.navSelectedElement&&(e.remove(this.navSelectedElement,"is-nav-selected"),delete this.navSelectedElement)},i.prototype.onNavStaticClick=function(t,e,i,n){"number"==typeof n&&this.navCompanion.select(n)},i.prototype.deactivateAsNavFor=function(){this.removeNavSelectedElement()},i.prototype.destroyAsNavFor=function(){this.navCompanion&&(this.navCompanion.off("cellSelect",this.onNavCompanionSelect),this.off("staticClick",this.onNavStaticClick),delete this.navCompanion)},i}),function(t,e){"function"==typeof define&&define.amd?define("imagesloaded/imagesloaded",["eventEmitter/EventEmitter","eventie/eventie"],function(i,n){return e(t,i,n)}):"object"==typeof exports?module.exports=e(t,require("wolfy87-eventemitter"),require("eventie")):t.imagesLoaded=e(t,t.EventEmitter,t.eventie)}(window,function(t,e,i){function n(t,e){for(var i in e)t[i]=e[i];return t}function o(t){return"[object Array]"===d.call(t)}function r(t){var e=[];if(o(t))e=t;else if("number"==typeof t.length)for(var i=0,n=t.length;n>i;i++)e.push(t[i]);else e.push(t);return e}function s(t,e,i){if(!(this instanceof s))return new s(t,e);"string"==typeof t&&(t=document.querySelectorAll(t)),this.elements=r(t),this.options=n({},this.options),"function"==typeof e?i=e:n(this.options,e),i&&this.on("always",i),this.getImages(),c&&(this.jqDeferred=new c.Deferred);var o=this;setTimeout(function(){o.check()})}function a(t){this.img=t}function l(t){this.src=t,u[t]=this}var c=t.jQuery,h=t.console,p="undefined"!=typeof h,d=Object.prototype.toString;s.prototype=new e,s.prototype.options={},s.prototype.getImages=function(){this.images=[];for(var t=0,e=this.elements.length;e>t;t++){var i=this.elements[t];"IMG"===i.nodeName&&this.addImage(i);var n=i.nodeType;if(n&&(1===n||9===n||11===n))for(var o=i.querySelectorAll("img"),r=0,s=o.length;s>r;r++){var a=o[r];this.addImage(a)}}},s.prototype.addImage=function(t){var e=new a(t);this.images.push(e)},s.prototype.check=function(){function t(t,o){return e.options.debug&&p&&h.log("confirm",t,o),e.progress(t),i++,i===n&&e.complete(),!0}var e=this,i=0,n=this.images.length;if(this.hasAnyBroken=!1,!n)return void this.complete();for(var o=0;n>o;o++){var r=this.images[o];r.on("confirm",t),r.check()}},s.prototype.progress=function(t){this.hasAnyBroken=this.hasAnyBroken||!t.isLoaded;var e=this;setTimeout(function(){e.emit("progress",e,t),e.jqDeferred&&e.jqDeferred.notify&&e.jqDeferred.notify(e,t)})},s.prototype.complete=function(){var t=this.hasAnyBroken?"fail":"done";this.isComplete=!0;var e=this;setTimeout(function(){if(e.emit(t,e),e.emit("always",e),e.jqDeferred){var i=e.hasAnyBroken?"reject":"resolve";e.jqDeferred[i](e)}})},c&&(c.fn.imagesLoaded=function(t,e){var i=new s(this,t,e);return i.jqDeferred.promise(c(this))}),a.prototype=new e,a.prototype.check=function(){var t=u[this.img.src]||new l(this.img.src);if(t.isConfirmed)return void this.confirm(t.isLoaded,"cached was confirmed");if(this.img.complete&&void 0!==this.img.naturalWidth)return void this.confirm(0!==this.img.naturalWidth,"naturalWidth");var e=this;t.on("confirm",function(t,i){return e.confirm(t.isLoaded,i),!0}),t.check()},a.prototype.confirm=function(t,e){this.isLoaded=t,this.emit("confirm",this,e)};var u={};return l.prototype=new e,l.prototype.check=function(){if(!this.isChecked){var t=new Image;i.bind(t,"load",this),i.bind(t,"error",this),t.src=this.src,this.isChecked=!0}},l.prototype.handleEvent=function(t){var e="on"+t.type;this[e]&&this[e](t)},l.prototype.onload=function(t){this.confirm(!0,"onload"),this.unbindProxyEvents(t)},l.prototype.onerror=function(t){this.confirm(!1,"onerror"),this.unbindProxyEvents(t)},l.prototype.confirm=function(t,e){this.isConfirmed=!0,this.isLoaded=t,this.emit("confirm",this,e)},l.prototype.unbindProxyEvents=function(t){i.unbind(t.target,"load",this),i.unbind(t.target,"error",this)},s}),function(t,e){"function"==typeof define&&define.amd?define(["flickity/js/index","imagesloaded/imagesloaded"],function(i,n){return e(t,i,n)}):"object"==typeof exports?module.exports=e(t,require("flickity"),require("imagesloaded")):t.Flickity=e(t,t.Flickity,t.imagesLoaded)}(window,function(t,e,i){return e.createMethods.push("_createImagesLoaded"),e.prototype._createImagesLoaded=function(){this.on("activate",this.imagesLoaded)},e.prototype.imagesLoaded=function(){function t(t,i){var n=e.getParentCell(i.img);e.cellSizeChange(n&&n.element),e.options.freeScroll||e.positionSliderAtSelected()}if(this.options.imagesLoaded){var e=this;i(this.slider).on("progress",t)}},e});;function ajaxrun(url,param,fun){if("string"==typeof param)var params=param;if("object"==typeof param)var params=jQuery.param(param);return $.ajax({url:url,type:"post",data:params,dataType:"json",cache:!1,timeout:1e4,success:function(data){"function"==typeof fun?fun(data):"string"==typeof fun&&eval(fun+"(data)")},complete:function(a,b){"timeout"==b&&(alert("请求超时"),showloaddinghtml5(0))},error:function(a,b,c){"timeout"==b&&(alert("请求超时"),showloaddinghtml5(0))}}),!1}function comajax(a){var b=a.url||originAPI,c=(a.cache||!1,a.type||"post"),d=a.debug||!1,e=a.funSuccess||function(){};delete a.url,delete a.cache,delete a.type,delete a.debug,delete a.funSuccess;var f=a.api||"";delete a.api;var b=originAPI+requestInfo[f],g=a,h=JSON.stringify(g);return console.log(jQuery.param(g)),"get"==c&&(b=b+"?"+jQuery.param(g)),1==d&&(console.log("请求地址:"+b),console.log("请求数据:"+h)),$.ajax({url:b,type:c,data:"get"==c?"":jQuery.param(g),dataType:"json",cache:!1,timeout:5e3,success:function(a){return 1==d&&(console.log("返回结果:"),console.log(a)),0==a.result&&(errorCode=a.errorCode,showloaddinghtml5(0)),1==a.result,"function"==typeof e&&e(a),!1},complete:function(a,b){"timeout"==b&&(mess_tusi("请求超时"),showloaddinghtml5(0))},error:function(a,b,c){console.log(a),console.log(b),"timeout"==b&&(mess_tusi("请求超时"),showloaddinghtml5(0)),"error"==b&&(mess_tusi("请求出错"),showloaddinghtml5(0))}}),!1}function opendivAll(a){var b=function(b,c){void 0==c&&(c="");var d=a[b]?a[b]:"";return""!=d?d:c},c=this,a=a,d=$("."+b("divclassname")),e=1==b("edgestyle")?"background: #fff;box-shadow:0 0 5px 0px rgba(255,255,255,.6),0 0 1px 2px rgba(0,0,0,.3),0 0 2px 5px rgba(0,0,0,.3);border-radius:5px !important;":"",f=d.width(),g=d.height(),h=($(window).width()-f)/2+parseInt(b("offsetleft",0)),i=($(window).height()-g)/2+parseInt(b("offsettop",0)),j=g;""!=b("title")&&(j+=36);var k='<div id="opendiv" style=" position: absolute;top:'+$(window).scrollTop()+'px;left:0;right:0;bottom:0;width:100%;height:100%; z-index: 99999999999; background:rgba(0,0,0,.3);">';k+='<div style="width:'+f+"px;height:"+j+"px;top:"+i+"px;left:"+h+"px; position:absolute;z-index:10001;overflow: hidden;"+e+'">',parseInt(b("isshowclose",1))&&(k+='<div class="openclose" style="position: absolute;right:0px;top:0px;border-radius:5px;"><img src="data:image/png;base64,")"></div>'),b("title")&&(k+='<div class="opentitle" style="padding: 8px 0px;text-align: center;background: #efefef;border-radius: 5px 5px 0px 0px;font-size: 14px;">'+b("title")+"</div>"),k+='<div class="opencon" ></div>',k+="</div>",k+="</div>",$("#opendiv").size()<=0&&$("body").append(k),d.appendTo($("#opendiv").find(".opencon")).show(),$(".openclose").click(function(){c.close()}),this.close=function(){d.appendTo($("body")).hide(),$("#opendiv").remove()}}function mess_tusi(a){clearTimeout(tusitemp),$("#mess_tusi").remove(),$("#mess_tusi").attr("id")?$("#mess_tusi").html(a):$("body").append("<div id='mess_tusi' style='position:fixed;font-size:16px;border-radius:4px !important;background:rgba(0,0,0,.7);color:#fff;display:none;'><span style='display:block;padding:5px 15px;'>"+a+"</span></div>");var b=($(window).width()-$("#mess_tusi").width())/2,c=.8*$(window).height();return $("#mess_tusi").css({left:b+"px",top:c+"px"}),$("#mess_tusi").css("display",""),tusitemp=setTimeout(function(){$("#mess_tusi").remove(),$("#mess_tusi").html("")},2e3),!1}function mess_tanchuang(data,funok,funno){var params={};if(params.content=void 0==data.content?data:data.content,params.width=void 0==data.width?"200px":data.width,params.isQueding=void 0==data.isQueding?"1":data.isQueding,params.isQuxiao=void 0==data.isQuxiao?"0":data.isQuxiao,1==params.isQueding&&1==params.isQuxiao)var tempW="width:49.5%;";else var tempW="width:100%;";var anniustyle="color: #888787;font-size: 16px;text-align: center;float: left;display:block;"+tempW+"line-height: 40px;",strs="<div style='position:fixed;top:0px;left:0px;right:0px;bottom:0px;background:rgba(0,0,0,0.2);z-index:99999999999'>\n                <div id='mess_tanchuang' style='width: "+params.width+" ; position: fixed; font-size:16px; border-radius: 4px; left: 50%; top: 50%;background: rgb(255, 255, 255);box-shadow: 0px 0px 15px rgba(0,0,0,.5),-0px -0px 15px rgba(0,0,0,.5);'>\n                <div style='padding:30px 15px;border-bottom: solid #ccc 1px;text-align:center;'>"+params.content+"</div>";strs+="<center style='display:flex'>",0!=params.isQueding&&(strs=strs+"<a href='javascript:void(0);' class='queding' style='"+anniustyle+"'>确定</a>"),0!=params.isQuxiao&&(strs=strs+"<a href='javascript:void(0);' class='quxiao' style='"+anniustyle+";border-left: solid 1px #ECEAEA;'>取消</a>"),strs+="</center>\n                </div>\n                </div>",$("body").append(strs),$("#mess_tanchuang .quxiao").click(function(event){event.preventDefault(),event.stopPropagation(),"function"==typeof funno?funno():"string"==typeof funno&&eval(funno),$("#mess_tanchuang").parent().remove()}),$("#mess_tanchuang .queding").click(function(event){event.preventDefault(),event.stopPropagation(),"function"==typeof funok?funok():"string"==typeof funok&&eval(funok),$("#mess_tanchuang").parent().remove()});var mleft=$("#mess_tanchuang").width()/2,mtop=$("#mess_tanchuang").height()/2;return $("#mess_tanchuang").css({"margin-left":"-"+mleft+"px","margin-top":"-"+mtop+"px"}),!1}function showloaddinghtml5(a,b){0==a?$("#mess_loaddinghtml5").remove():(""!=b&&void 0!=b||(b="正在处理中..."),$("#mess_loaddinghtml5").attr("id")||$("body").append('<div id="mess_loaddinghtml5"><div class="loadding"><div class="loaddingtishi">'+b+'</div><div class="spinner"><div class="spinner-container container1"><div class="circle1"></div><div class="circle2"></div><div class="circle3"></div><div class="circle4"></div></div><div class="spinner-container container2"><div class="circle1"></div><div class="circle2"></div><div class="circle3"></div><div class="circle4"></div></div><div class="spinner-container container3"><div class="circle1"></div><div class="circle2"></div><div class="circle3"></div><div class="circle4"></div></div></div></div></div>'),$("#mess_loaddinghtml5").css("display",""))}function getUrlParams(a,b){b||(b=window.location.href);var c={},b=decodeURI(b),d=b.indexOf("?");if(d>0)for(var e,f,g=b.substring(d+1),h=g.split("&"),i=0;e=h[i];i++)f=h[i]=e.split("="),c[f[0]]=f.length>1?f[1]:!0;return c[a]}function daojishi(a,b){var c=function(){this.obj=a,this.time=b,this.ttt="",this.init()};c.prototype={init:function(){var a=this;console.log(a.time),a.obj.attr("disabled",!0).html(this.time+"秒后重新获取").css({"background-color":"#ccc"}),a.ttt=setInterval(function(){a.time--,0==a.time?(clearInterval(a.ttt),a.obj.removeAttr("disabled").html("获取验证码").css({"background-color":"#3eb5fa"})):a.obj.html(a.time+"秒后重新获取")},1e3)}};new c(a,b)}jQuery.easing.jswing=jQuery.easing.swing,jQuery.extend(jQuery.easing,{def:"easeOutQuad",swing:function(a,b,c,d,e){return jQuery.easing[jQuery.easing.def](a,b,c,d,e)},easeInQuad:function(a,b,c,d,e){return d*(b/=e)*b+c},easeOutQuad:function(a,b,c,d,e){return-d*(b/=e)*(b-2)+c},easeInOutQuad:function(a,b,c,d,e){return(b/=e/2)<1?d/2*b*b+c:-d/2*(--b*(b-2)-1)+c},easeInCubic:function(a,b,c,d,e){return d*(b/=e)*b*b+c},easeOutCubic:function(a,b,c,d,e){return d*((b=b/e-1)*b*b+1)+c},easeInOutCubic:function(a,b,c,d,e){return(b/=e/2)<1?d/2*b*b*b+c:d/2*((b-=2)*b*b+2)+c},easeInQuart:function(a,b,c,d,e){return d*(b/=e)*b*b*b+c},easeOutQuart:function(a,b,c,d,e){return-d*((b=b/e-1)*b*b*b-1)+c},easeInOutQuart:function(a,b,c,d,e){return(b/=e/2)<1?d/2*b*b*b*b+c:-d/2*((b-=2)*b*b*b-2)+c},easeInQuint:function(a,b,c,d,e){return d*(b/=e)*b*b*b*b+c},easeOutQuint:function(a,b,c,d,e){return d*((b=b/e-1)*b*b*b*b+1)+c},easeInOutQuint:function(a,b,c,d,e){return(b/=e/2)<1?d/2*b*b*b*b*b+c:d/2*((b-=2)*b*b*b*b+2)+c},easeInSine:function(a,b,c,d,e){return-d*Math.cos(b/e*(Math.PI/2))+d+c},easeOutSine:function(a,b,c,d,e){return d*Math.sin(b/e*(Math.PI/2))+c},easeInOutSine:function(a,b,c,d,e){return-d/2*(Math.cos(Math.PI*b/e)-1)+c},easeInExpo:function(a,b,c,d,e){return 0==b?c:d*Math.pow(2,10*(b/e-1))+c},easeOutExpo:function(a,b,c,d,e){return b==e?c+d:d*(-Math.pow(2,-10*b/e)+1)+c},easeInOutExpo:function(a,b,c,d,e){return 0==b?c:b==e?c+d:(b/=e/2)<1?d/2*Math.pow(2,10*(b-1))+c:d/2*(-Math.pow(2,-10*--b)+2)+c},easeInCirc:function(a,b,c,d,e){return-d*(Math.sqrt(1-(b/=e)*b)-1)+c},easeOutCirc:function(a,b,c,d,e){return d*Math.sqrt(1-(b=b/e-1)*b)+c},easeInOutCirc:function(a,b,c,d,e){return(b/=e/2)<1?-d/2*(Math.sqrt(1-b*b)-1)+c:d/2*(Math.sqrt(1-(b-=2)*b)+1)+c},easeInElastic:function(a,b,c,d,e){var f=1.70158,g=0,h=d;if(0==b)return c;if(1==(b/=e))return c+d;if(g||(g=.3*e),h<Math.abs(d)){h=d;var f=g/4}else var f=g/(2*Math.PI)*Math.asin(d/h);return-(h*Math.pow(2,10*(b-=1))*Math.sin((b*e-f)*(2*Math.PI)/g))+c},easeOutElastic:function(a,b,c,d,e){var f=1.70158,g=0,h=d;if(0==b)return c;if(1==(b/=e))return c+d;if(g||(g=.3*e),h<Math.abs(d)){h=d;var f=g/4}else var f=g/(2*Math.PI)*Math.asin(d/h);return h*Math.pow(2,-10*b)*Math.sin((b*e-f)*(2*Math.PI)/g)+d+c},easeInOutElastic:function(a,b,c,d,e){var f=1.70158,g=0,h=d;if(0==b)return c;if(2==(b/=e/2))return c+d;if(g||(g=e*(.3*1.5)),h<Math.abs(d)){h=d;var f=g/4}else var f=g/(2*Math.PI)*Math.asin(d/h);return 1>b?-.5*(h*Math.pow(2,10*(b-=1))*Math.sin((b*e-f)*(2*Math.PI)/g))+c:h*Math.pow(2,-10*(b-=1))*Math.sin((b*e-f)*(2*Math.PI)/g)*.5+d+c},easeInBack:function(a,b,c,d,e,f){return void 0==f&&(f=1.70158),d*(b/=e)*b*((f+1)*b-f)+c},easeOutBack:function(a,b,c,d,e,f){return void 0==f&&(f=1.70158),d*((b=b/e-1)*b*((f+1)*b+f)+1)+c},easeInOutBack:function(a,b,c,d,e,f){return void 0==f&&(f=1.70158),(b/=e/2)<1?d/2*(b*b*(((f*=1.525)+1)*b-f))+c:d/2*((b-=2)*b*(((f*=1.525)+1)*b+f)+2)+c},easeInBounce:function(a,b,c,d,e){return d-jQuery.easing.easeOutBounce(a,e-b,0,d,e)+c},easeOutBounce:function(a,b,c,d,e){return(b/=e)<1/2.75?d*(7.5625*b*b)+c:2/2.75>b?d*(7.5625*(b-=1.5/2.75)*b+.75)+c:2.5/2.75>b?d*(7.5625*(b-=2.25/2.75)*b+.9375)+c:d*(7.5625*(b-=2.625/2.75)*b+.984375)+c},easeInOutBounce:function(a,b,c,d,e){return e/2>b?.5*jQuery.easing.easeInBounce(a,2*b,0,d,e)+c:.5*jQuery.easing.easeOutBounce(a,2*b-e,0,d,e)+.5*d+c}}),function(a){function b(){try{return h in a&&a[h]}catch(b){return!1}}function c(a){return function(){var b=Array.prototype.slice.call(arguments,0);b.unshift(e),j.appendChild(e),e.addBehavior("#default#userData"),e.load(h);var c=a.apply(f,b);return j.removeChild(e),c}}function d(a){return a.replace(/^d/,"___$&").replace(m,"___")}var e,f={},g=a.document,h="localStorage",i="script";if(f.disabled=!1,f.set=function(a,b){},f.get=function(a){},f.remove=function(a){},f.clear=function(){},f.transact=function(a,b,c){var d=f.get(a);null==c&&(c=b,b=null),"undefined"==typeof d&&(d=b||{}),c(d),f.set(a,d)},f.getAll=function(){},f.forEach=function(){},f.serialize=function(a){return JSON.stringify(a)},f.deserialize=function(a){if("string"==typeof a)try{return JSON.parse(a)}catch(b){return a||void 0}},b())e=a[h],f.set=function(a,b){return void 0===b?f.remove(a):(e.setItem(a,f.serialize(b)),b)},f.get=function(a){return f.deserialize(e.getItem(a))},f.remove=function(a){e.removeItem(a)},f.clear=function(){e.clear()},f.getAll=function(){var a={};return f.forEach(function(b,c){a[b]=c}),a},f.forEach=function(a){for(var b=0;b<e.length;b++){var c=e.key(b);a(c,f.get(c))}};else if(g.documentElement.addBehavior){var j,k;try{k=new ActiveXObject("htmlfile"),k.open(),k.write("<"+i+">document.w=window</"+i+'><iframe src="/favicon.ico"></iframe>'),k.close(),j=k.w.frames[0].document,e=j.createElement("div")}catch(l){e=g.createElement("div"),j=g.body}var m=new RegExp("[!\"#$%&'()*+,/\\\\:;<=>?@[\\]^`{|}~]","g");f.set=c(function(a,b,c){return b=d(b),void 0===c?f.remove(b):(a.setAttribute(b,f.serialize(c)),a.save(h),c)}),f.get=c(function(a,b){return b=d(b),f.deserialize(a.getAttribute(b))}),f.remove=c(function(a,b){b=d(b),a.removeAttribute(b),a.save(h)}),f.clear=c(function(a){var b=a.XMLDocument.documentElement.attributes;a.load(h);for(var c,d=0;c=b[d];d++)a.removeAttribute(c.name);a.save(h)}),f.getAll=function(a){var b={};return f.forEach(function(a,c){b[a]=c}),b},f.forEach=c(function(a,b){for(var c,d=a.XMLDocument.documentElement.attributes,e=0;c=d[e];++e)b(c.name,f.deserialize(a.getAttribute(c.name)))})}try{var n="__storejs__";f.set(n,n),f.get(n)!=n&&(f.disabled=!0),f.remove(n)}catch(l){f.disabled=!0}f.enabled=!f.disabled,"undefined"!=typeof module&&module.exports&&this.module!==module?module.exports=f:"function"==typeof define&&define.amd?define(f):a.store=f}(Function("return this")());var storeWithExpiration={set:function(a,b,c){store.set(a,{val:b,exp:c,time:(new Date).getTime()})},get:function(a){var b=store.get(a);return b?(new Date).getTime()-b.time>b.exp?null:b.val:null}};jQuery.support.cors=!0;var e=function(){document.all?window.event.returnValue=!1:(event.preventDefault(),event.stopPropagation())},tusitemp="";!function(){var a="ontouchstart"in document.documentElement?"touchstart":"click",b=$.fn.on;$.fn.on=function(){return arguments[0]="click"===arguments[0]?a:arguments[0],b.apply(this,arguments)}}(),$.extend({log:function(a){var b=new Date,c=b.getFullYear(),d=b.getMonth()+1,e=b.getDate(),f=b.getHours(),g=b.getMinutes(),h=b.getSeconds(),i=c+"/"+d+"/"+e+" "+f+":"+g+":"+h;console.log(i),console.log(a)}}),function(a,b){var c="orientationchange"in b?"orientationchange":"resize",d=use_screen_base.indexOf("_mate"),e=parseInt(use_screen_base),f=a.documentElement,g=function(){var a=(f.clientWidth,b.innerWidth);f.style.fontSize=100*(a/e)+"px"};if(/iPad.*OS|iPhone.*OS/.test(navigator.userAgent)&&d>0){var h=a.querySelectorAll("meta[name=viewport]");h[0]&&h[0].setAttribute("content","width=device-width, user-scalable=no, initial-scale="+1/b.devicePixelRatio)}g(),b.addEventListener(c,g,!1),delete use_screen_base}(document,window),!function(a){"use strict";function b(){}function c(a,b){return b.indexOf(a)>-1}function d(a){return"[object Array]"===Object.prototype.toString.call(a)}function e(a){return"[object Object]"===Object.prototype.toString.call(a)}function f(a,b){return a.className.match(new RegExp("(\\s|^)("+b+")(\\s|$)"))}function g(a,b){f(a,b)||(a.className+=" "+b)}function h(a,b){f(a,b)&&(a.className=a.className.replace(RegExp("(\\s|^)("+b+")(\\s|$)"),"$3"))}function i(a){return/<\/?[^>]*>/.test(a)?!1:/^(?:(https|http|ftp|rtsp|mms):)?(\/\/)?(\w+:{0,1}\w*@)?([^\?#:\/]+\.[a-z]+|\d+\.\d+\.\d+\.\d+)?(:[0-9]+)?((?:\.?\/)?([^\?#]*)?(\?[^#]+)?(#.+)?)?$/.test(a)}function j(a){return Array.prototype.slice.apply(a,Array.prototype.slice.call(arguments,1))}function k(a){return a.replace(/^[a-z]/,function(a){return a.toUpperCase()})}var l=function(){var a=j(arguments,0,3);if(!a.length)throw new Error("Parameters required!");var b=e(a.slice(-1)[0])?a.pop():{};switch(a.length){case 2:b.data=b.data||a[1];case 1:b.dom=b.dom||a[0]}if(!b.dom)throw new Error("Container can not be empty!");if(!b.data||!b.data.length)throw new Error("Data must be an array and must have more than one element!");this._opts=b,b=null,a=null,this._setting(),this.fire("initialize"),this._renderWrapper(),this._initPlugins(),this._bindHandler(),this.fire("initialized"),this._autoPlay()};l.VERSION="2.1.7",l.EVENTS=["initialize","initialized","pluginInitialize","pluginInitialized","renderComplete","slide","slideStart","slideEnd","slideChange","slideChanged","slideRestore","slideRestored","loadData","reset","destroy"],l.EASING=[["linear","ease","ease-in","ease-out","ease-in-out"],/cubic-bezier\(([^\d]*(\d+.?\d*)[^\,]*\,?){4}\)/],l.FIX_PAGE_TAGS=["SELECT","INPUT","TEXTAREA","BUTTON","LABEL"],l.NODE_TYPE={unknown:"unknown",empty:"empty",pic:"pic",dom:"dom",html:"html",node:"node",element:"element"},l.TRANSITION_END_EVENT=null,l.BROWSER_PREFIX=null,function(){var a=document.createElement("fakeElement");[["WebkitTransition","webkitTransitionEnd","webkit"],["transition","transitionend",null],["MozTransition","transitionend","moz"],["OTransition","oTransitionEnd","o"]].some(function(b){return void 0!==a.style[b[0]]?(l.TRANSITION_END_EVENT=b[1],l.BROWSER_PREFIX=b[2],!0):void 0})}(),l.DEVICE_EVENTS=function(){var b=!!("ontouchstart"in a&&!/Mac OS X /.test(a.navigator.userAgent)||a.DocumentTouch&&document instanceof a.DocumentTouch);return{hasTouch:b,startEvt:b?"touchstart":"mousedown",moveEvt:b?"touchmove":"mousemove",endEvt:b?"touchend":"mouseup",cancelEvt:b?"touchcancel":"mouseout",resizeEvt:"onorientationchange"in a?"orientationchange":"resize"}}(),l.extend=function(){var a,b,c=arguments;switch(c.length){case 0:return;case 1:a=l.prototype,b=c[0];break;case 2:a=c[0],b=c[1]}for(var d in b)b.hasOwnProperty(d)&&(a[d]=b[d])},l.plugins={},l.regPlugin=function(a,b){l.plugins[a]=l.plugins[a]||b},l.styleProp=function(a,b){return l.BROWSER_PREFIX?b?l.BROWSER_PREFIX+k(a):"-"+l.BROWSER_PREFIX+"-"+a:a},l.setStyle=function(a,b,c){a.style[l.styleProp(b,1)]=c},l.getStyle=function(a,b){return a.style[l.styleProp(b,1)]},l._animateFuncs={normal:function(){function a(a,b,c,d,e){l.setStyle(a,"transform","translateZ(0) translate"+b+"("+(e+c*(d-1))+"px)")}return a.effect=l.styleProp("transform"),a}()};var m=l.prototype;m.extend=l.extend,m._setting=function(){var e=this;e._plugins=l.plugins,e._animateFuncs=l._animateFuncs,e._holding=!1,e._locking=!1,e._intermediateScene=null,e._transitionEndHandler=null,e._LSN={autoPlay:null,resize:null,transitionEnd:null},e.currentEl=null,e._EventHandle={},e.onMoving=!1,e.onSliding=!1,e.direction=null;var f=this._opts;e.wrap=f.dom,e.data=f.data,e.isVertical=!!f.isVertical,e.isOverspread=!!f.isOverspread,e.duration=f.duration||2e3,e.initIndex=f.initIndex>0&&f.initIndex<=f.data.length-1?f.initIndex:0,e.fixPage=function(){var a=f.fixPage;return a===!1||0===a?!1:d(a)&&a.length>0||"string"==typeof a&&""!==a?[].concat(a).toString():!0}(),e.fillSeam=!!f.fillSeam,e.slideIndex=e.slideIndex||e.initIndex||0,e.axis=e.isVertical?"Y":"X",e.reverseAxis="Y"===e.axis?"X":"Y",e.width="number"==typeof f.width?f.width:e.wrap.offsetWidth,e.height="number"==typeof f.height?f.height:e.wrap.offsetHeight,e.ratio=e.height/e.width,e.scale=e.isVertical?e.height:e.width,e.offset=e.offset||{X:0,Y:0},e.isTouchable=null==f.isTouchable?!0:!!f.isTouchable,e.isLooping=!!(f.isLooping&&e.data.length>1),e.dampingForce=Math.max(0,Math.min(1,parseFloat(f.dampingForce)||0)),e.delay=f.delay||0,e.isAutoplay=!!(f.isAutoplay&&e.data.length>1),e.animateType=f.animateType in e._animateFuncs?f.animateType:"normal",e._animateFunc=e._animateFuncs[e.animateType],e._animateReverse=function(){var a=[];for(var b in e._animateFuncs)e._animateFuncs.hasOwnProperty(b)&&e._animateFuncs[b].reverse&&a.push(b);return a}(),e.isVertical&&"card"===e.animateType&&(e.isOverspread=!0),e.log=f.isDebug?function(){a.console.log.apply(a.console,arguments)}:b,e._damping=function(){return function(a){return.62*Math.atan(Math.abs(a)/e.scale)*(1-e.dampingForce)*e.scale*(a>0?1:-1)}}(),e.animateTime=null!=f.animateTime&&f.animateTime>-1?f.animateTime:300,e.animateEasing=c(f.animateEasing,l.EASING[0])||l.EASING[1].test(f.animateEasing)?f.animateEasing:"ease",e.deviceEvents=l.DEVICE_EVENTS,e.fingerRecognitionRange=f.fingerRecognitionRange>-1?parseInt(f.fingerRecognitionRange):10,e.events={},l.EVENTS.forEach(function(a){var b=f["on"+a.toLowerCase()];"function"==typeof b&&e.on(a,b,1)}),e.pluginConfig=function(){var a={};return d(f.plugins)&&f.plugins.forEach(function(b){d(b)?a[b[0]]=b.slice(1):"string"==typeof b&&(a[b]=[])}),a}()},m._initPlugins=function(){var a=this.pluginConfig,b=this._plugins;for(var c in a)a.hasOwnProperty(c)&&b.hasOwnProperty(c)&&b[c]&&"function"==typeof b[c]&&typeof b[c].apply&&b[c].apply(this,a[c]);this.fire("pluginInitialized")},m._itemType=function(a){if(isNaN(a)||(a=this.data[a]),a.hasOwnProperty("type"))return a.type;var b,c=a.content,d=l.NODE_TYPE;return b=null==c?d.empty:Boolean(c.nodeName)&&Boolean(c.nodeType)?d.node:"string"==typeof c?i(c)?d.pic:d.html:d.unknown,a.type=b,b},m._renderItem=function(a,b){var c,d=this,e=this.data.length,f=function(){var b=' src="'+c.content+'"';b+=c.height/c.width>d.ratio?' height="100%"':' width="100%"',d.isOverspread&&(a.style.cssText+="background-image:url("+c.content+");background-repeat:no-repeat;background-position:50% 50%;background-size:cover",b+=' style="display:block;opacity:0;height:100%;width:100%;"'),a.innerHTML="<img"+b+" />"};if(a.innerHTML="",a.style.background="",this.isLooping||null!=this.data[b]){b=(e+b)%e,c=this.data[b];var g=this._itemType(c),h=l.NODE_TYPE;switch(a.className="islider-"+g,g){case h.pic:if(2===c.load)f();else{var i=new Image;i.src=c.content,i.onload=function(){c.height=i.height,c.width=i.width,f(),c.load=2}}break;case h.dom:case h.html:a.innerHTML=c.content;break;case h.node:case h.element:if(11===c.content.nodeType){var j=document.createElement("div");j.appendChild(c.content),c.content=j}a.appendChild(c.content)}}},m._renderIntermediateScene=function(){null!=this._intermediateScene&&(this._renderItem.apply(this,this._intermediateScene),this._intermediateScene=null)},m._changedStyles=function(){var a=["islider-prev","islider-active","islider-next"];this.els.forEach(function(b,c){h(b,a.join("|")),g(b,a[c]),this.fillSeam&&this.originScale(b)}.bind(this))},m._renderWrapper=function(){var b;this.outer?(b=this.outer,b.innerHTML=""):b=document.createElement("ul"),b.className="islider-outer",this.els=[];for(var c=0;3>c;c++){var d=document.createElement("li");this.els.push(d),this._animateFunc(d,this.axis,this.scale,c,0),this.fixPage||(d.style.overflow="auto"),!this.isVertical||"rotate"!==this.animateType&&"flip"!==this.animateType?this._renderItem(d,c-1+this.slideIndex):this._renderItem(d,1-c+this.slideIndex),b.appendChild(d)}this._changedStyles(),this.fillSeam&&this.els.forEach(function(a,b){g(a,"islider-sliding"+(1===b?"-focus":""))}),a.setTimeout(function(){this._preloadImg(this.slideIndex)}.bind(this),200),this.outer||(this.outer=b,this.wrap.appendChild(b)),this.currentEl=this.els[1],this.fire("renderComplete",this.slideIndex,this.currentEl,this)},m._preloadImg=function(a){if(this.data.length>3){var b=this.data,c=b.length,d=this,e=function(a){var c=b[a];if("pic"===d._itemType(c)&&!c.load){var e=new Image;e.src=c.content,e.onload=function(){c.width=e.width,c.height=e.height,c.load=2},c.load=1}};e((a+2)%c),e((a-2+c)%c)}},m._watchTransitionEnd=function(b,c){var d=function(){this._unWatchTransitionEnd(),"slideChanged"===c&&this._changedStyles(),this.fire.call(this,c,this.slideIndex,this.currentEl,this),this._renderIntermediateScene(),this.play(),this.onSliding=!1,this.direction=null}.bind(this);l.TRANSITION_END_EVENT&&(this.currentEl.addEventListener(l.TRANSITION_END_EVENT,d),this._transitionEndHandler={el:this.currentEl,handler:d}),this._LSN.transitionEnd=a.setTimeout(d,b)},m._unWatchTransitionEnd=function(){this._LSN.transitionEnd&&a.clearTimeout(this._LSN.transitionEnd),null!==this._transitionEndHandler&&(this._transitionEndHandler.el.removeEventListener(l.TRANSITION_END_EVENT,this._transitionEndHandler.handler),this._transitionEndHandler=null)},m._bindHandler=function(){var b=this.outer,c=this.deviceEvents;this.isTouchable&&(c.hasTouch||(b.style.cursor="pointer",b.ondragstart=function(a){return!a}),b.addEventListener(c.startEvt,this),b.addEventListener(c.moveEvt,this),b.addEventListener(c.endEvt,this),!c.hasTouch&&b.addEventListener("mouseout",this)),a.addEventListener(c.resizeEvt,this),a.addEventListener("focus",this,!1),a.addEventListener("blur",this,!1)},m.handleEvent=function(a){var b=this.deviceEvents;switch(a.type){case"mousedown":if(0!==a.button)break;case"touchstart":this.startHandler(a);break;case b.moveEvt:this.moveHandler(a);break;case b.endEvt:case b.cancelEvt:this.endHandler(a);break;case b.resizeEvt:this.resizeHandler();break;case"focus":this.play();break;case"blur":this.pause()}},m.startHandler=function(a){if(this.fixPage&&l.FIX_PAGE_TAGS.indexOf(a.target.tagName.toUpperCase())<0&&!this._isItself(a.target)&&a.preventDefault(),!this._holding&&!this._locking){var b=this.deviceEvents;this.onMoving=!0,this.pause(),this.fire("slideStart",a,this),this.startTime=(new Date).getTime(),this.startX=b.hasTouch?a.targetTouches[0].pageX:a.pageX,this.startY=b.hasTouch?a.targetTouches[0].pageY:a.pageY}},m.moveHandler=function(a){if(this.onMoving){var b=this.deviceEvents,c=this.data.length,d=this.axis,e=this.reverseAxis,f={};a.hasOwnProperty("offsetRatio")?(f[d]=a.offsetRatio*this.scale,f[e]=0):(f.X=b.hasTouch?a.targetTouches[0].pageX-this.startX:a.pageX-this.startX,f.Y=b.hasTouch?a.targetTouches[0].pageY-this.startY:a.pageY-this.startY),this.offset=f,a.offsetRatio=f[d]/this.scale,Math.abs(f[d])-Math.abs(f[e])>10&&(a.preventDefault(),this._unWatchTransitionEnd(),this.isLooping||(f[d]>0&&0===this.slideIndex||f[d]<0&&this.slideIndex===c-1)&&(f[d]=this._damping(f[d])),this.els.forEach(function(a,b){a.style.visibility="visible",l.setStyle(a,"transition","none"),this._animateFunc(a,d,this.scale,b,f[d],f[d]),this.fillSeam&&this.seamScale(a)}.bind(this)),this.fire("slide",a,this))}},m.endHandler=function(b){function c(d){if(null!=d)if("A"===d.tagName){if(d.href)return"_blank"===d.getAttribute("target")?a.open(d.href):a.location.href=d.href,b.preventDefault(),!1}else{if("LI"===d.tagName&&d.className.search(/^islider\-/)>-1)return!1;c(d.parentNode)}}if(this.onMoving){this.onMoving=!1;var d=this.offset,e=this.axis,f=this.scale/2,g=(new Date).getTime(),h=this.fingerRecognitionRange;f=g-this.startTime>300?f:14;var i=Math.abs(d[e]),j=Math.abs(d[this.reverseAxis]);this.fire("slideEnd",b,this),d[e]>=f&&i>j?this.slideTo(this.slideIndex-1):d[e]<-f&&i>j?this.slideTo(this.slideIndex+1):Math.abs(this.offset[e])>=h&&this.slideTo(this.slideIndex),Math.abs(this.offset[e])<h&&this.fixPage&&b.target&&c(b.target),this.offset.X=this.offset.Y=0}},m.resizeHandler=function(){var b,c,d=this._LSN.resize,e=+new Date;this.deviceEvents.hasTouch?(d&&a.clearInterval(d),d=a.setInterval(function(){this.height!==this.wrap.offsetHeight||this.width!==this.wrap.offsetWidth?(d&&a.clearInterval(d),d=a.setInterval(function(){b===this.wrap.offsetWidth&&c===this.wrap.offsetHeight?(d&&a.clearInterval(d),this.reset()):(b=this.wrap.offsetWidth,c=this.wrap.offsetHeight)}.bind(this),12)):+new Date-e>=1e3&&d&&a.clearInterval(d)}.bind(this),12)):(d&&a.clearTimeout(d),d=a.setTimeout(function(){(this.height!==this.wrap.offsetHeight||this.width!==this.wrap.offsetWidth)&&(d&&a.clearInterval(d),this.reset())}.bind(this),200))},m.slideTo=function(a,b){if(this.isAutoplay&&this.pause(),!this._locking){this.unhold(),this.onSliding=!0;var d,e=this.animateTime,f=this.animateType,i=this._animateFunc,j=this.data,k=this.els,m=this.axis,n=a,o=a-this.slideIndex,p=this.offset,q=0;"object"==typeof b&&(b.animateTime>-1&&(e=b.animateTime),"string"==typeof b.animateType&&b.animateType in this._animateFuncs&&(f=b.animateType,i=this._animateFuncs[f])),0!==p[m]&&(q=Math.abs(p[m])/this.scale*e),Math.abs(o)>1&&this._renderItem(o>0?this.els[2]:this.els[0],n),this._preloadImg(n),j[n]?this.slideIndex=n:this.isLooping?this.slideIndex=o>0?0:j.length-1:o=0;var r,s,t;0===o?d="slideRestore":((this.isVertical&&c(f,this._animateReverse))^o>0?(k.push(k.shift()),r=k[2],s=k[0],t=1):(k.unshift(k.pop()),r=k[0],s=k[2],t=-1),this.currentEl=k[1],1===Math.abs(o)?(this._renderIntermediateScene(),this._renderItem(r,n+o)):Math.abs(o)>1&&(this._renderItem(r,n+t),this._intermediateScene=[s,n-t]),l.setStyle(r,"transition","none"),q=e-q,d="slideChange",this.fillSeam&&(k.forEach(function(a){h(a,"islider-sliding|islider-sliding-focus")}),g(this.currentEl,"islider-sliding-focus"),g(r,"islider-sliding")),this.direction=t);for(var u=0;3>u;u++)k[u]!==r&&l.setStyle(k[u],"transition",(i.effect||"all")+" "+q+"ms "+this.animateEasing),i.call(this,k[u],m,this.scale,u,0,t),this.fillSeam&&this.seamScale(k[u]);this._watchTransitionEnd(q,d+"d"),this.fire(d,this.slideIndex,this.currentEl,this)}},m.slideNext=function(){this.slideTo.apply(this,[this.slideIndex+1].concat(j(arguments)))},m.slidePrev=function(){this.slideTo.apply(this,[this.slideIndex-1].concat(j(arguments)))},m.regPlugin=function(){var a=j(arguments),b=a.shift(),d=a[0];(this._plugins.hasOwnProperty(b)||"function"==typeof d)&&("function"==typeof d&&(this._plugins[b]=d,a.shift()),c(b,this._opts.plugins)||(this._opts.plugins.push(a.length?[].concat([b],a):b),"function"==typeof this._plugins[b]&&this._plugins[b].apply(this,a)))},m.bind=m.delegate=function(b,c,d){function e(b){for(var e=a.event?a.event:b,f=e.target,g=document.querySelectorAll(c),h=0;h<g.length;h++)if(f===g[h]){d.call(f);break}}this.wrap.addEventListener(b,e,!1);var f=b+";"+c;this._EventHandle.hasOwnProperty(f)?(this._EventHandle[f][0].push(d),this._EventHandle[f][1].push(e)):this._EventHandle[f]=[[d],[e]]},m.unbind=m.unDelegate=function(a,b,c){var d=a+";"+b;if(this._EventHandle.hasOwnProperty(d)){var e=this._EventHandle[d][0].indexOf(c);if(e>-1)return this.wrap.removeEventListener(a,this._EventHandle[d][1][e]),this._EventHandle[d][0][e]=this._EventHandle[d][1][e]=null,!0}return!1},m.destroy=function(){var b=this.outer,c=this.deviceEvents;this.fire("destroy"),this.isTouchable&&(b.removeEventListener(c.startEvt,this),b.removeEventListener(c.moveEvt,this),b.removeEventListener(c.endEvt,this),
!c.hasTouch&&b.removeEventListener("mouseout",this)),a.removeEventListener(c.resizeEvt,this),a.removeEventListener("focus",this),a.removeEventListener("blur",this);var d;for(d in this._EventHandle)for(var e=this._EventHandle[d][1],f=0;f<e.length;f++)"function"==typeof e[f]&&this.wrap.removeEventListener(d.substr(0,d.indexOf(";")),e[f]);this._EventHandle=null;for(d in this._LSN)this._LSN.hasOwnProperty(d)&&this._LSN[d]&&a.clearTimeout(this._LSN[d]);this._LSN=null,this.wrap.innerHTML=""},m.on=function(a,b,d){c(a,l.EVENTS)&&"function"==typeof b&&(!(a in this.events)&&(this.events[a]=[]),d?this.events[a].unshift(b):this.events[a].push(b))},m.has=function(a,b){return a in this.events?-1<this.events[a].indexOf(b):!1},m.off=function(a,b){if(a in this.events){var c=this.events[a].indexOf(b);c>-1&&delete this.events[a][c]}},m.fire=function(a){var b=j(arguments,1);a.split(/\x20+/).forEach(function(a){if(a in this.events)for(var c=this.events[a],d=0;d<c.length;d++)"function"==typeof c[d]&&c[d].apply&&c[d].apply(this,b)}.bind(this))},m.reset=function(){this.pause(),this._unWatchTransitionEnd(),this.width="number"==typeof this._opts.width?this._opts.width:this.wrap.offsetWidth,this.height="number"==typeof this._opts.height?this._opts.height:this.wrap.offsetHeight,this.ratio=this.height/this.width,this.scale=this.isVertical?this.height:this.width,this._renderWrapper(),this._autoPlay(),this.fire("reset slideRestored",this.slideIndex,this.currentEl,this)},m.loadData=function(a,b){this.pause(),this._unWatchTransitionEnd(),this.slideIndex=b||0,this.data=a,this._renderWrapper(),this._autoPlay(),this.fire("loadData slideChanged",this.slideIndex,this.currentEl,this)},m.pushData=function(a){if(null!=a){var b=this.data.length;this.data=this.data.concat(a),this.isLooping&&0===this.slideIndex?this._renderItem(this.els[0],this.data.length-1):b-1===this.slideIndex&&(this._renderItem(this.els[2],b),this._autoPlay())}},m.unshiftData=function(a){if(null!=a){d(a)||(a=[a]);var b=a.length;this.data=a.concat(this.data),0===this.slideIndex&&this._renderItem(this.els[0],b-1),this.slideIndex+=b}},m._autoPlay=function(){this.delay>0?a.setTimeout(this.play.bind(this),this.delay):this.play()},m.play=function(){this.pause(),this.isAutoplay&&(this.isLooping||this.slideIndex<this.data.length-1)&&(this._LSN.autoPlay=a.setTimeout(this.slideNext.bind(this),this.duration))},m.pause=function(){this._LSN.autoPlay&&a.clearTimeout(this._LSN.autoPlay)},m.hold=function(){this._holding=!0},m.unhold=function(){this._holding=!1,this.unlock()},m.lock=function(){this.hold(),this._locking=!0},m.unlock=function(){this._locking=!1},m.seamScale=function(a){var b=/scale([XY]?)\(([^\)]+)\)/,c=l.getStyle(a,"transform");b.test(c)?l.setStyle(a,"transform",c.replace(b,function(a,b,c){var d={};return b?(d[b]=parseFloat(c),"scale"+this.axis+"("+(b===this.axis?1.001*d[this.axis]:1.001)+")"):(c.indexOf(",")>-1?(c=c.split(","),d.X=parseFloat(c[0]),d.Y=parseFloat(c[1])):d.Y=d.X=parseFloat(c),d[this.axis]*=1.001,"scale("+d.X+", "+d.Y+")")}.bind(this))):l.setStyle(a,"transform",c+" scale"+this.axis+"(1.001)")},m.originScale=function(a){var b=/([\x20]?scale)([XY]?)\(([^\)]+)\)/;l.setStyle(a,"transform",l.getStyle(a,"transform").replace(b,function(a,b,c,d){return a={},c?"1.001"===d?"":(a[c]=parseFloat(d),"scale"+this.axis+"("+(c===this.axis?a[this.axis]/1.001:1)+")"):(d.indexOf(",")>-1?(d=d.split(","),a.X=parseFloat(d[0]),a.Y=parseFloat(d[1])):a.Y=a.X=parseFloat(d),a[this.axis]/=1.001,"scale("+a.X+", "+a.Y+")")}.bind(this)))},m._isItself=function(a){var b=this.fixPage;if("string"==typeof b){for(var c,d=[],e=a;!f(e,"islider-outer")&&e!==this.wrap;)d.push(e),e=e.parentNode;if(e=d.pop(),d.length)try{if(c=Array.prototype.slice.call(e.querySelectorAll(b)),c.length)for(var g=0;g<d.length;g++)if(c.indexOf(d[g])>-1)return!0}catch(h){return!1}}return!1},m.subjectTo=function(a,b){if(!(!a instanceof l)){var c=this;c.animateTime=a.animateTime,c.isLooping=a.isLooping,c.isAutoplay=!1,a.on("slideStart",function(a){c.startHandler(a)}),a.on("slide",function(a){c.moveHandler(a)}),a.on("slideEnd",function(a){c.endHandler(a)}),a.on("slideChange",function(a){var b=c.data.length,d=c.direction;d>0&&(a-c.slideIndex+b)%b===1?c.slideNext():0>d&&(a-c.slideIndex-b)%b===-1&&c.slidePrev()}),a.on("slideRestore",function(a){c.slideIndex!==a&&c.slideTo(a)})}},"function"==typeof require&&"object"==typeof module&&module&&"object"==typeof exports&&exports?module.exports=l:"function"==typeof define&&define.amd?define(function(){return l}):a.iSlider=a.iSlider||l}(window||this);