...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String transactionID="1003850366201510101152085455";
            String outTradeNo="20151010180500000001";
            String deviceInfo="865136024833713";
            String outRefundNo="20151010180500001111";
            int totalFee=2;
            int refundFee=2;
            String opUserID="banjiajia";
            ...
            System.out.print(refundReqData);
...
//            ScanPayReqData scanPayReqData=new ScanPayReqData();
            ...
            //--------------------------------------------------------------------
            //温馨提示，第一次使用该SDK时请到com.tenpay.common.Configure类里面进行配置
            //--------------------------------------------------------------------
           ...
           // Util.log(Signature.getSignFromResponseString(Util.getLocalXMLString("/test/com/tenpay/business/refundqueryserviceresponsedata/refundquerysuccess2.xml")));
