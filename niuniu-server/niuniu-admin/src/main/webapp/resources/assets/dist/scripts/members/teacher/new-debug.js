 ...
 * product list  --douzy
 */
define("banjiajia/web/1.0.0/scripts/members/teacher/new-debug", [ "$-debug", "ace-elements-debug", "validation-debug", "tree-debug", "map-debug" ], function(require, exports, module) {
    var $ = require("$-debug");
