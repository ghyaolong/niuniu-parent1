 ...
 * product list  --douzy
 */
define("banjiajia/web/1.0.0/scripts/system/sms/template/list-debug", [ "$-debug", "pager-debug", "util-debug", "ace-elements-debug", "jggrid-debug", "gridlocale-debug", "validation-debug" ], function(require, exports, module) {
    ...
    function fetchData(event, originalEvent, type, page) {
        ...
        $.ajax({
            url: _contentPath + "/system/sms/template/list/query.json?begin=" + begin,
            async: true,
            dataType: "json",
            success: function(data) {
                relaodDate(data.smsTemplates);
            },
